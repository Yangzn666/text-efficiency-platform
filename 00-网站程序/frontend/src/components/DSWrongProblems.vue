...
const problems = ref<WrongProblem[]>([
  {
    ...
    chapterName: '第一章 绪论',
    sectionId: '1.1',
    sectionName: '1.1 数据结构的基本概念',
    title: '数据结构的三要素（DS-WD-1.1.3-XT-1）',
    content: '一个完整的数据结构通常应包含以下哪些要素（）？\nA. 数据元素及其存储方式\nB. 数据的逻辑结构和物理结构\nC. 数据的逻辑结构、存储结构以及在其上定义的基本操作\nD. 数据对象和数据元素之间的关系',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：数据结构包含三要素：逻辑结构、存储结构（物理结构）、数据的运算（基本操作）。缺一不可。A只提到了存储方式，B缺少运算，D描述不准确。',
  ...
  },
  {
    ...
    sectionId: '1.1',
    sectionName: '1.1 数据结构的基本概念',
    title: '逻辑结构的判断（DS-WD-1.1.3-XT-3）',
    content: '下列选项中，属于逻辑结构的是（）。\nA. 顺序表\nB. 哈希表\nC. 有序表\nD. 单链表',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：有序表是逻辑结构（元素之间按某种规则有序排列）。顺序表、哈希表、单链表都是存储结构（物理结构）。逻辑结构关注元素之间的关系，存储结构关注如何在计算机中表示。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '1.1',
    sectionName: '1.1 数据结构的基本概念',
    title: '逻辑结构与存储结构的关系（DS-WD-1.1.3-XT-4）',
    content: '以下关于数据结构的说法中，正确的是（）。\nA. 数据的逻辑结构独立于其存储结构\nB. 数据的存储结构独立于其逻辑结构\nC. 数据的逻辑结构唯一决定其存储结构\nD. 数据结构仅由其逻辑结构和存储结构决定',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：A\n解析：逻辑结构独立于存储结构是重要结论！同一逻辑结构可以有多种存储实现（如线性表可以用顺序表或链表实现）。B错在存储结构依赖逻辑结构；C错在不是唯一决定；D错在还缺少运算。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '1.1',
    sectionName: '1.1 数据结构的基本概念',
    title: '数据存储的核心原则（DS-WD-1.1.3-XT-5）',
    content: '在存储数据时，通常不仅要存储各数据元素的值，还要存储（）。\nA. 数据的操作方法\nB. 数据元素的类型\nC. 数据元素之间的关系\nD. 数据的存取方法',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：数据结构的核心就是研究数据元素之间的关系。顺序存储通过物理位置相邻表示关系，链式存储通过指针表示关系。只存储元素值而不存储关系，就无法体现数据结构。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    title: '算法的特性理解（DS-WD-1.2.3-XT-2）',
    content: '下列关于算法的说法中，正确的是（）。\nA. 算法的时间效率取决于算法执行所花的CPU的时间\nB. 在算法设计中不允许用牺牲空间效率的方式来换取好的时间效率\nC. 算法必须具备有穷性、确定性等五个特征\nD. 通常用时间效率和空间效率来衡量算法的优劣',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：A错在时间效率用时间复杂度衡量，与具体机器无关；B错在时空权衡是常用策略；算法五大特性：有穷性、确定性、可行性、输入、输出。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '1.2',
    sectionName: '1.2 算法和算法评价',
    title: '空间复杂度O(1)的正确理解（DS-WD-1.2.3-XT-4）',
    content: '某算法的空间复杂度为O(1)，则表示该算法（）。\nA. 不需要任何辅助空间\nB. 所需辅助空间大小与问题规模n无关\nC. 不需要任何空间\nD. 所需空间大小与问题规模n无关',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：O(1)表示空间复杂度是常数阶，即所需辅助空间是固定的，不随n变化。可以有变量，但变量个数是固定的。A、C错在"不需要任何空间"；D错在"所需空间"应包括输入数据，而O(1)只指额外辅助空间。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  },
  {
    ...
    sectionId: '1.2',
    sectionName: '1.2 算法和算法评价',
    title: '【2019统考真题1】程序段时间复杂度（DS-WD-1.2.3-XT-16）',
    content: '设n是描述问题规模的非负整数，下列程序段的时间复杂度是（）。\nx=0;\nwhile (n>=(x+1)*(x+1))\nx=x+1;\nA. O(logn)\nB. O(n^(1/2))\nC. O(n)\nD. O(n²)',
    mistakeType: '计算错误',
    importance: 5,
    correction: '正确答案：B\n解析：循环条件n≥(x+1)²，即(x+1)²≤n，x+1≤√n，x≤√n-1。循环执行次数约为√n次，时间复杂度为O(n^(1/2))。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  // ==================== 第二章 线性表 错题 ====================
  {
    ...
    chapterName: '第二章 线性表',
    sectionId: '2.1',
    sectionName: '2.1 线性表的基本概念',
    title: '线性表的定义（DS-WD-2.1.3-XT-1）',
    content: '线性表是具有n个（）的有限序列。\nA. 数据表\nB. 字符\nC. 数据元素\nD. 数据项',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：线性表的定义是具有相同数据类型的n个数据元素的有限序列。数据元素是基本单位，数据项是数据元素中不可分割的最小单位。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  },
  {
    ...
    sectionId: '2.2',
    sectionName: '2.2 顺序表',
    title: '顺序表的应用场景选择（DS-WD-2.2.3-XT-5）',
    content: '若线性表最常用的操作是存取第i个元素及其前驱和后继元素的值，为了提高效率，应采用（）的存储方式。\nA. 单链表\nB. 双向链表\nC. 单循环链表\nD. 顺序表',
    mistakeType: '应用错误',
    importance: 5,
    correction: '正确答案：D\n解析：顺序表支持随机访问，可以在O(1)时间内存取任意位置的元素及其前驱后继。链表需要遍历，时间复杂度O(n)。题目强调"存取"操作，顺序表最优。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.2',
    sectionName: '2.2 顺序表',
    title: '顺序表动态扩容的空间要求（DS-WD-2.2.3-XT-12）',
    content: '顺序表的插入算法中，当n个空间已满时，可再申请增加分配m个空间，若申请失败，则说明系统没有（）可分配的存储空间。\nA. m个\nB. m个连续\nC. n+m个\nD. n+m个连续',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：顺序表要求存储空间连续，扩容时需要申请m个连续的空间。系统可能有m个空间但不连续，导致申请失败。这是顺序表的主要缺点。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '单链表连接的时间复杂度（DS-WD-2.3.7-XT-8）',
    content: '将长度为n的单链表链接在长度为m的单链表后面，其算法的时间复杂度采用大O形式表示应该是（）。\nA. O(1)\nB. O(n)\nC. O(m)\nD. O(n+m)',
    mistakeType: '计算错误',
    importance: 5,
    correction: '正确答案：C\n解析：需要将第一个链表（长度m）遍历到尾结点O(m)，然后修改尾结点的next指向第二个链表（长度n）的头O(1)，总时间复杂度O(m)。与n无关，因为不需要遍历第二个链表。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '头结点的作用（DS-WD-2.3.7-XT-9）',
    content: '单链表中，增加一个头结点的目的是（）。\nA. 使单链表至少有一个结点\nB. 标识表结点中首结点的位置\nC. 方便运算的实现\nD. 说明单链表是线性表的链式存储',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：C\n解析：头结点的主要作用是统一空表和非空表的操作，使插入、删除等操作不需要特殊处理第一个结点，方便运算的实现。A、B、D都不是主要目的。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '带头结点单链表的操作复杂度（DS-WD-2.3.7-XT-10）',
    content: '在一个长度为n的带头结点的单链表h上，设有尾指针r，则执行（）操作与链表的表长有关。\nA. 删除单链表中的第一个元素\nB. 删除单链表中的最后一个元素\nC. 在单链表第一个元素前插入一个新元素\nD. 在单链表最后一个元素后插入一个新元素',
    mistakeType: '计算错误',
    importance: 5,
    correction: '正确答案：B\n解析：A、C操作在表头，时间复杂度O(1)；D操作有尾指针r，时间复杂度O(1)；B操作删除最后一个元素需要找到倒数第二个结点（前驱），单链表只能从头遍历，时间复杂度O(n)，与表长有关。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '头插法建立链表的顺序（DS-WD-2.3.7-XT-13）',
    content: '通过含有n(n>1)个元素的数组a，采用头插法建立单链表L，则L中的元素次序（）。\nA. 与数组a的元素次序相同\nB. 与数组a的元素次序相反\nC. 与数组a的元素次序无关\nD. 以上都错误',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：头插法每次将新节点插入到头结点之后，先插入的元素会被后续的节点推到后面。如果数组a的顺序是a[0],a[1],...,a[n-1]，则链表中顺序为a[n-1],...,a[1],a[0]，与数组次序相反。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '双链表插入操作的语句序列（DS-WD-2.3.7-XT-17）',
    content: '如下图所示的双链表中，已知指针p指向结点A，若要在结点A和C之间插入指针q所指的结点B，则依次执行的语句序列可以是（）。\n① q->next=p->next; ② q->prior=p; ③ p->next=q; ④ p->next->prior=q;\nA. ①②④③\nB. ④③②①\nC. ③④①②\nD. ①③④②',
    mistakeType: '思路错误',
    importance: 5,
    correction: '正确答案：A\n解析：双链表插入要注意顺序：①先将q的next指向C（p->next）②将q的prior指向A（p）③将C的prior指向q（p->next->prior=q，必须在修改p->next之前）④最后将A的next指向q（p->next=q）。顺序①②④③正确。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '有序链表插入的时间复杂度（DS-WD-2.3.7-XT-19）',
    content: '在长度为n的有序单链表中插入一个新结点，并仍然保持有序的时间复杂度是（）。\nA. O(1)\nB. O(n)\nC. O(n²)\nD. O(nlog₂n)',
    mistakeType: '计算错误',
    importance: 5,
    correction: '正确答案：B\n解析：链表不支持二分查找，必须从头结点开始逐个比较找到插入位置O(n)，然后修改指针O(1)。总时间复杂度O(n)。与顺序表不同，链表无法利用有序性加速查找。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '循环链表长度判断（DS-WD-2.3.7-XT-27）',
    content: '某线性表用带头结点的循环单链表存储，头指针为head，当head->next->next==head成立时，线性表的长度可能是（）。\nA. 0\nB. 1\nC. 2\nD. 可能为0或1',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：D\n解析：head->next->next==head说明从head走两步回到head。情况1：空表，head->next=head，此时head->next->next=head->next=head也成立，长度为0；情况2：只有一个结点，head->next指向该结点，该结点next指向head，长度为1。所以可能为0或1。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '静态链表的特点（DS-WD-2.3.7-XT-30）',
    content: '需要分配较大空间，插入和删除不需要移动元素的线性表，其存储结构为（）。\nA. 单链表\nB. 静态链表\nC. 顺序表\nD. 双链表',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：静态链表用数组实现（预先分配较大空间），通过游标（数组下标）模拟指针，插入删除只需修改游标，不需要移动元素。结合了顺序存储和链式存储的优点。单链表和双链表是动态分配，顺序表插入删除需要移动元素。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '静态链表的性质判断（DS-WD-2.3.7-XT-31）',
    content: '下列关于静态链表的说法中，正确的是（）。\nI. 静态链表兼具顺序表和单链表的优点，因此存取表中第i个元素的时间与i无关\nII. 静态链表能容纳的最大元素个数在表定义时就确定了，以后不能增加\nIII. 静态链表与动态链表在元素的插入、删除上类似，不需要移动元素\nIV. 相比动态链表，静态链表可能浪费较多的存储空间\nA. I、II、III\nB. II、III、IV\nC. I、III、IV\nD. I、II、IV',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：I错误，静态链表不能随机访问，存取第i个元素仍需遍历，与i有关；II正确，静态链表用数组实现，大小在定义时确定；III正确，插入删除只需修改游标，不移动元素；IV正确，静态链表需预先分配数组空间，可能浪费。所以II、III、IV正确。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  ...
  },
  {
    ...
    sectionId: '2.3',
    sectionName: '2.3 链表',
    title: '2024统考真题：链表结点移动操作（DS-WD-2.3.7-XT-36）',
    content: '【2024统考真题1】已知带头结点的非空单链表L的头指针为h，结点结构为data|next，其中next是指向直接后继结点的指针。现有指针p和q，若p指向L中非首且非尾的任意一个结点，则执行语句序列"q=p->next; p->next=q->next; q->next=h->next; h->next=q;"的结果是（）。\nA. 在p所指结点后插入q所指结点\nB. 在q所指结点后插入p所指结点\nC. 将p所指结点移至L的头结点之后\nD. 将q所指结点移动到L的头结点之后',
    mistakeType: '思路错误',
    importance: 5,
    correction: '正确答案：D\n解析：逐句分析：①q=p->next（q指向p的后继结点）②p->next=q->next（将q从链表中摘除，p直接指向q的后继）③q->next=h->next（q指向原来首元结点）④h->next=q（头结点指向q，q成为新的首元结点）。整体效果：将q所指结点从原位置摘下，插入到头结点之后，成为新的首元结点。',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '3.1',
    sectionName: '3.1 栈的基本概念',
    title: '3个不同元素进栈的出栈序列数（Catalan数）',
    content: '3个不同元素依次进栈，能得到（）种不同的出栈序列。\nA. 4\nB. 5\nC. 6\nD. 7',
    mistakeType: '概念不清',
    importance: 5,
    correction: '正确答案：B\n解析：n个不同元素进栈的合法出栈序列数为Catalan数：C(2n,n)/(n+1)\n当n=3时：Catalan(3) = C(6,3)/4 = 20/4 = 5种\n5种序列分别为：abc, acb, bac, bca, cba（cab不可能）',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '3.1',
    sectionName: '3.1 栈的基本概念',
    title: '栈的输入输出序列关系（P3=1时P1的值）',
    content: '若栈的输入序列是P₁,P₂,...,Pₙ，输出序列是1,2,3,...,n。若P₃=1，则P₁的值（）。\nA. 可能是2\nB. 一定是2\nC. 不可能是2\nD. 不可能是3',
    mistakeType: '思路错误',
    importance: 5,
    correction: '正确答案：C\n解析：P₃=1说明1是第三个入栈的元素，那么P₁和P₂必须在1之前入栈。\n- 如果P₁=2，则2比1先入栈，但输出要求1先出（输出序列1,2,3...）\n- 2在栈中比1深，必须先出1才能出2，这与1先输出矛盾\n- 所以P₁不可能是2，只能是大于1的数',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '3.1',
    sectionName: '3.1 栈的基本概念',
    title: '栈的输入输出序列关系（P3=3时P1的值）',
    content: '若栈的输入序列是P₁,P₂,...,Pₙ，输出序列是1,2,3,...,n。若P₃=3，则P₁的值（）。\nA. 可能是2\nB. 不可能是1\nC. 一定是1\nD. 一定是2',
    mistakeType: '思路错误',
    importance: 5,
    correction: '正确答案：A\n解析：P₃=3说明3是第三个入栈的元素。\n- 例1：P₁=2, P₂=1, P₃=3，入栈2,1,3，出栈3,1,2合法\n- 例2：P₁=1, P₂=2, P₃=3，入栈1,2,3，出栈3,2,1合法\n- 所以P₁可能是1也可能是2，答案是“可能是2”',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
  },
  {
    ...
    sectionId: '3.1',
    sectionName: '3.1 栈的基本概念',
    title: '字符序列进栈的合法C标识符数量',
    content: '设栈的初始状态为空，当字符序列"n1_"作为栈的输入时，输出长度为3，且可用做C语言标识符的序列有（）个。\nA. 4\nB. 5\nC. 3\nD. 6',
    mistakeType: '综合应用',
    importance: 5,
    correction: '正确答案：C\n解析：C语言标识符规则：只能以字母或下划线开头，不能以数字开头。\n序列"n1_"的所有出栈序列（Catalan(3)=5种）：\n- n1_ ✅（合法）\n- n_1 ✅（合法）\n- 1n_ ❌（数字开头）\n- 1_n ❌（数字开头）\n- _n1 ✅（合法）\n- _1n ✅（合法）\n但题目要求输出长度为3，所以有3种合法标识符',
    createdAt: new Date().toISOString(),
    reviewCount: 0,
    lastReviewAt: '',
    mastered: false
